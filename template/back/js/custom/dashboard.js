	...
	$(document).ready(function() {
		...
		var gauge = new Gauge(target).setOptions(opts1); // create sexy gauge!
                    gauge.maxValue = res_1_max; // set max gauge value
		gauge.animationSpeed = 32; // set animation speed (32 is default value)
                    gauge.set(res_1); // set actual value
		...
		var gauge = new Gauge(target).setOptions(opts2); // create sexy gauge!
                    gauge.maxValue = res_2_max; // set max gauge value
		gauge.animationSpeed = 32; // set animation speed (32 is default value)
                    gauge.set(res_2); // set actual value
		...
		var gauge = new Gauge(target).setOptions(opts3); // create sexy gauge!
                    gauge.maxValue = res_3_max; // set max gauge value
		gauge.animationSpeed = 32; // set animation speed (32 is default value)
                    gauge.set(res_3); // set actual value
		gauge.setTextField(document.getElementById("gauge3-txt"));
                }
		
                var target = document.getElementById('gauge11'); // your canvas element
                if(target!=null){
                    var gauge = new Gauge(target).setOptions(opts1); // create sexy gauge!
                    gauge.maxValue = res_4_max; // set max gauge value
                    gauge.animationSpeed = 32; // set animation speed (32 is default value)
                    gauge.set(res_4); // set actual value
                    gauge.setTextField(document.getElementById("gauge11-txt"));
                }
                
                var target = document.getElementById('gauge12'); // your canvas element
                if(target!=null){
		var gauge = new Gauge(target).setOptions(opts2); // create sexy gauge!
                    gauge.maxValue = res_5_max; // set max gauge value
		gauge.animationSpeed = 32; // set animation speed (32 is default value)
                    gauge.set(res_5); // set actual value
                    gauge.setTextField(document.getElementById("gauge12-txt"));
                }
		
                var target = document.getElementById('gauge13'); // your canvas element
		if(target!=null){
                    var gauge = new Gauge(target).setOptions(opts3); // create sexy gauge!
                    gauge.maxValue = res_6_max; // set max gauge value
                    gauge.animationSpeed = 32; // set animation speed (32 is default value)
                    gauge.set(res_6); // set actual value
                    gauge.setTextField(document.getElementById("gauge13-txt"));
                }
