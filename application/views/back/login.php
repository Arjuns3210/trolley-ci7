		...
		<div class="cls-content">
                    <div>
                        <span style="color: black;">
                            <h3>
                            <?php
                                if($login_type=='callcenter'){
                                    echo 'Call Center Login';
                                }
                                elseif($login_type=='buyer'){
                                    echo 'Buyer Login';
                                }
                                elseif($login_type=='warehouse'){
                                    echo 'Warehouse Login';
                                }elseif($login_type=='accounts'){
	                                echo 'Accounts Login';
                                }
                                elseif($login_type=='admin'){
                                    echo 'Admin Login';
                                }
                                elseif($login_type=='samplewarehouse'){
                                    echo 'Sample Warehouse Login';
                                }
                                elseif($login_type=='contenteditor'){
                                    echo 'Content Editor Login';
                                }elseif($login_type=='scheduler'){
	                                echo 'Scheduler Login';
                                }
                            ?>
                            </h3>
                        </span>
