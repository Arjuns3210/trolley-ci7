...
<div id="content-container">
    <div id="page-title">
        <h1 class="page-header text-overflow"><?php echo translate('Bill Of Quantity with date range Report');?></h1>
    </div>
    <div class="tab-base">
        <div class="panel">
            <div class="panel-body">
                ...
                <!-- LIST -->
                    <div class="tab-pane fade active in" id="" style="border:1px solid #ebebeb; border-radius:4px;">
						<?php
                            echo form_open(base_url() . 'index.php/admin/exportBillQtyReport', array(
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                     ...
                                     <div class="col-sm-6">
                                         <select id="supplier" name="supplier" class="demo-chosen-select form-control " >
