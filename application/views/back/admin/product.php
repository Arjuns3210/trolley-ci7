                    ...
                    <div class="tab-content">
                        <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
                            ...
                            <button class="btn btn-info btn-labeled fa fa-step-backward pull-right pro_list_btn" 
                                style="display:none;"  onclick="dlt_cont_func = 'delete';list_cont_func = 'list'; ajax_set_list(); proceed('to_add');"><?php echo translate('back_to_product_list');?>
                            </button>
                        </div>
                    <!-- LIST -->
...
<script>
	...
	function proceed(type){
		if(type == 'to_list'){
			...
			// var list = $('#list');
			// list.html('');
			// list.html(HISTORY_1).fadeIn(); // fade in response data
		}
	}
</script>
