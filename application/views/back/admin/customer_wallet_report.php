...
<div id="content-container">
    <div id="page-title">
        <h1 class="page-header text-overflow"><?php echo translate('Customer Wallet Date Range Report');?></h1>
    </div>
    <div class="tab-base">
        <div class="panel">
            <div class="panel-body">
                ...
                <!-- LIST -->
                    <div class="tab-pane fade active in" id="" style="border:1px solid #ebebeb; border-radius:4px;">
                        <?php
                            echo form_open(base_url() . 'admin/exportCustomerWalletReport', array(
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" for="demo-hor-customer">Select Customer</label>
                                    <div class="col-sm-6">
                                        <?php echo $this->crud_model->select_html( 'user', 'user', 'first_name|fourth_name|phone', 'add', 'demo-chosen-select' ); ?>
                                    </div>
                                </div>
                        </div>
...
<script>
    ...
    var user_type = 'admin';
    var module = 'customerWalletReport';
    var list_cont_func = '';
    var dlt_cont_func = '';
</script>
