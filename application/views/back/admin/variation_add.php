	...
	<div class="tab-pane fade active in" id="edit">
		<?php
			echo form_open(base_url() . 'index.php/admin/product/variation_doadd/' .$product_details[0]['product_id'], array(
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="attr<?php echo $attr['attribute_id']; ?>" id="attr<?php echo $attr['attribute_id']; ?>" 
                                                ...
                                                ?>
                                                <option value="<?php echo $attrval['attributevalue_id']; ?>" ><?php echo $attrval['value']; ?></option>
                                                <?php
                                                    }
                                                }
                                                ?>
