...
<div>
    <?php
		echo form_open(base_url() . 'index.php/admin/user/destroy_wallet_balance/' . $row['user_id'], array(
				'class' => 'form-horizontal',
				'method' => 'post',
				'id' => 'wallet_balance_destroy',
	...
	?>
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="demo-hor-2"><?php echo translate('reduce_balance');?></label>
                    <div class="col-sm-6">
