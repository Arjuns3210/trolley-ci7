...
<div id="content-container">
    <div id="page-title">
        <h1 class="page-header text-overflow"><?php echo translate( 'Update Delivery Boy Information' ); ?></h1>
    </div>
    <div class="tab-base">
        <div class="panel">
            <div class="panel-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade active in" id="" style="border:1px solid #ebebeb; border-radius:4px;">
						<?php
						echo form_open( base_url() . 'index.php/admin/updateDeliveryboyInfo/updateInfo', array(
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label" for="demo-hor-2">
                              ...
                              <div class="col-sm-6">
                                ...
                                <div class="col-md-4">
                                    <a  class="btn btn-success" id="sample_vs_exp" href="<?php echo base_url().'admin/updateDeliveryboyInfo/download' ; ?>">Download Sample File</a>
                                </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                                     <div class="col-md-5">
                                         <a  class="btn btn-warning pull-right mar-rgt" id="sample_vs_exp" href="<?php echo base_url().'admin/updateDeliveryboyInfo/downloadArea' ; ?>">Download Area Master Data</a>
                                    </div>
                                    <div class="col-md-2">
...
<script>
	...
	var user_type = 'admin';
	var module = 'updateDeliveryboyInfo';
	var list_cont_func = '';
	var dlt_cont_func = '';
</script>