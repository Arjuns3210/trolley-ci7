<div class="row">
    <div class="col-md-12">
		<?php
            echo form_open(base_url() . 'index.php/admin/supplier/do_add/', array(
                    ...
                    <div class="tab-content">
                    	<div id="personal_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <h4 class="text-thin text-center"><?php echo translate('supplier_details'); ?></h4>
                            </div>

                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('supplier_name');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="supplier_name" id="demo-hor-1" placeholder="<?php echo translate('supplier_name');?>" class="form-control required">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="mobile_number" id="demo-hor-3" placeholder="<?php echo translate('contact_number');?>" class="form-control required">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-4"><?php echo translate('supplier_email_address');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="email_address" id="demo-hor-4" placeholder="<?php echo translate('email_address');?>" class="form-control required">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5"><?php echo translate('supplier_address'); ?></label>
                                <div class="col-sm-6">
                                    <textarea rows="3" class="form-control" id="demo-hor-5"  name="address" ></textarea>
                                </div>
                            </div>
                        ...
                        <div id="payment_details" class="tab-pane fade">
                            <div class="form-group btm_border">
                                <h4 class="text-thin text-center"><?php echo translate('payment_details'); ?></h4>                            
                            </div>
                            
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-6"><?php echo translate('company_name');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="company_name" id="demo-hor-6" placeholder="<?php echo translate('company_name');?>" class="form-control required">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    <textarea name="payment_terms" id="demo-hor-7" placeholder="<?php echo translate('payment_terms');?>" class="form-control"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="3" class="form-control" id="demo-hor-8"  name="bank_details" ></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="3" class="form-control" id="demo-hor-9"  name="billing_address" ></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="3" class="form-control" id="demo-hor-10"  name="other_details" ></textarea>
                                </div>
                            </div>
           ...
           <div class="panel-footer">
                <div class="row">
                        ...
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right " 
                            onclick="ajax_set_full('add','<?php echo translate('add_supplier'); ?>','<?php echo translate('successfully_added!'); ?>','supplier_add',''); "><?php echo translate('reset');?>
                        </span>
                    
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right enterer" onclick="form_submit('supplier_add','<?php echo translate('supplier_has_been_added!'); ?>');proceed('to_add');" ><?php echo translate('upload');?></span>
