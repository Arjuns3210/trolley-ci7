        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="name" id="demo-hor-1" 
                    	placeholder="<?php echo translate('brand_name_in_english'); ?>" class="form-control required">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <br><br>
                    <p style="color:blue;font-weight: bold">Note : Upload file size <?php echo SIZE_DIMENSIONS['brand']; ?></p>
