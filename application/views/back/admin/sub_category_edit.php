        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-sm-4 control-label" for="demo-hor-inputemail">
                	<?php echo translate('sub-category_name_in_english');?>
                    	</label>
                <div class="col-sm-6">
                    <input type="text" name="sub_category_name" value="<?php echo $row['sub_category_name'];?>" class="form-control required" placeholder="<?php echo translate('sub-category_name_in_english'); ?>" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label" for="demo-hor-inputemail1">
                	<?php echo translate('sub-category_name_in_arabic');?>
                    	</label>
                <div class="col-sm-6">
                    <input type="text" name="sub_category_name_ar" value="<?php echo $row['sub_category_name_ar'];?>" class="form-control required" placeholder="<?php echo translate('sub-category_name_in_arabic'); ?>" >
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <br><br>
                    <p style="color:blue;font-weight: bold">Note : Upload file size <?php echo SIZE_DIMENSIONS['sub_category']; ?></p>
