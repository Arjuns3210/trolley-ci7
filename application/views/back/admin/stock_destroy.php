	...
	?>
        <div class="panel-body">
            ...
            <div class="form-group" id="var" style="display:none;">
                <label class="col-sm-4 control-label" for="demo-hor-31"><?php echo translate('sku_code');?></label>
...
//        total();
    ...
    function get_variations(id){
        $('#var').hide('slow');
        ajax_load(base_url+'index.php/admin/stock/var_by_pro/'+id,'variation','other');
        $('#var').show('slow');
//        total();
    }
