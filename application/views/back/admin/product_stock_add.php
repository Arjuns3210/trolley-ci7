	...
	?>
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="number" disabled value="<?php echo $this->crud_model->get_type_name_by_id('variation',$variation,'current_stock'); ?>" class="form-control totals">
                </div>
            </div>
            
            <div class="form-group">
                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('sku_code');?></label>
                <div class="col-sm-6">
                    <input type="text" disabled value="<?php echo $this->crud_model->get_type_name_by_id('variation',$variation,'sku_code'); ?>" class="form-control totals">
                </div>
            </div>
            ...
            <div class="form-group">
              ...
              <?php /* commeneted by mypcot team on 29/06/2018
            <div class="form-group">
